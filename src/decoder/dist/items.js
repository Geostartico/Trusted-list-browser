...
exports.Country = exports.Provider = exports.Service = void 0;
const UnorderedSet_js_1 = require("./UnorderedSet.js");
/**
...
class Provider {
    ...
    constructor(aName, aTspId, aTrustMark, aServiceTypes) {
        ...
        this.services = new UnorderedSet_js_1.UnorderedSet(10);
...
class Country {
    ...
    constructor(code) {
        ...
        this.providers = new UnorderedSet_js_1.UnorderedSet(10);
    }
    /**
